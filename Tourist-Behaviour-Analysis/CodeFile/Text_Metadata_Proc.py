...
# Specify input and output file and convert to CSV
input_file="Results/Input records/Filtered1M.csv"
output="Results/TextualMetadataProcessing/TP1M.csv"
data = pd.read_csv(input_file, header=None)
data.to_csv(output,columns=[0,1,3,5,12,13,14],index=False,header=['LineNo','PhotoID','UserID','DateTaken','Latitude','Longitude','Accuracy'])
